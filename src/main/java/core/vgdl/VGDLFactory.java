    ...
    private String[] effectStrings = new String[]
            {
                    ...
                    "changeResourceIfHeld", "transformAndChangeResource", "refreshVisionState", "transformIfAvatarNear", 
                    "transformIfAvatarFar", "exchangeResourceIfHeld", "killIfHeld"
            };
    ...
    private Class[] effectClasses = new Class[]
            {
                    ...
                    ChangeResourceIfHeld.class, TransformAndChangeResource.class, RefreshVisionState.class, TransformIfAvatarNear.class, 
                    TransformIfAvatarFar.class, ExchangeResourceIfHeld.class, KillIfHeld.class
            };
