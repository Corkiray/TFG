...
public class PDDLAction {
     ...
     */
    public PDDLAction(String actionInstance, String actionDescription) {
        this.actionInstance = actionInstance;
        this.GVGAIAction = this.translateActionInstanceToGVGAI();
     ...
     */
    private String translateActionInstanceToGVGAI() {
        // Create pattern
        ...
        String action = actionMatcher.group(0);
